...
function Contract(address, abi, symtab) {
...
function makeFunctionCall(functionName, args) { // previously functionNameToData
...
function syncContract(apiURL, f) {
    var done = false;
...
function handleStruct(baseKey, structFields) {
    var result = {};
